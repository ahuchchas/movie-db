...
export function getMovieById(id) {
  return movieList.results.find(
    (movie) => movie.id.toString() === id.toString()
  );
}

export function updateMovieById(id, title) {
  const movieIndex = movieList.results.findIndex(
    (movie) => movie.id.toString() === id.toString()
  );

  //update the title of the targeted movie
  movieList.results[movieIndex].title = title;
...
export function deleteMovieById(id) {
  const newMovieResults = movieList.results.filter(
    (movie) => movie.id.toString() !== id.toString()
  );
  movieList.results = newMovieResults;
